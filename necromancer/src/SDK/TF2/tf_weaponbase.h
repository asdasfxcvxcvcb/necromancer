...
public:
	...
	bool IsRapidFire() {
		if (auto pWeaponInfo = GetWeaponInfo())
			return pWeaponInfo->GetWeaponData(0).m_bUseRapidFireCrits; // TF_WEAPON_PRIMARY_MODE = 0
		return false;
	}
	...
	// CanBeSelected - checks if weapon can be selected/switched to
	bool CanBeSelected()
	{
		return reinterpret_cast<bool(__fastcall *)(void *)>(Memory::GetVFunc(this, 85))(this);
	}
};
