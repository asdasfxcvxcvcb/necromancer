...
public:
	...
	// Alias for Amalgam compatibility
	Vec3 EyeAngles() {
		return GetEyeAngles();
	}

	// GetEyePosition - returns eye position in world space
	Vec3 GetEyePosition() {
		return GetShootPos();
	}
	...
	// GetViewOffset - returns the view offset (eye position relative to origin)
	Vec3 GetViewOffset() {
