...
void CRadar::Run()
{
	...
	const auto crossColor = F::VisualUtils->GetAccentSecondaryWithAlpha(CFG::Radar_Cross_Alpha);
	const auto outlineColor = F::VisualUtils->GetAccentSecondaryWithAlpha(CFG::Radar_Outline_Alpha);
